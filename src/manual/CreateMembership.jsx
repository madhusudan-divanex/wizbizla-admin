...
function CreateMembership() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const data = { ...values, features: JSON.stringify(values.features), price: JSON.stringify(values.price) }
        try {
            const result = await postApiData('add-membership', data)
            if (result.status) {
                    ...
                    <div className="container mt-4">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="mb-0">Add Memberships</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    <div className="row mb-3">
                                        ...
                                        {values.type=='provider' &&<div className="col-sm-6">
                                        ...
                                        {values.features.map((item, index) => (
                                            <div className="row mb-2" key={index}>
                                                ...
                                                {index !== 0 && <div className="col-sm-4">
