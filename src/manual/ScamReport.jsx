        ...
        <>
            ...
            <div className='main-content'><div className="row mb-3">
                ...
                <div className="col-sm-6">
                    ...
                    <input id='name' type="text" className="form-control" value={scamData?.scamType} disabled />
                </div>
                <div className="col-sm-6">
                    <label htmlFor='name'>Service Category</label>
                    <input id='name' type="text" className="form-control" value={scamData?.serviceCategory} disabled />
                </div>
                <div className="col-sm-6">
