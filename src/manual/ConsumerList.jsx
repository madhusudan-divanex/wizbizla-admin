    ...
    const fetchUsers = async (pageNumber = page, searchQuery = search) => {
        try {
            const result = await getSecureApiData(
                `get-all-users?page=${pageNumber}&search=${encodeURIComponent(searchQuery)}&type=consumer`
            );
                ...
                <div className="container-fluid">
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0">Consumers</h5>
                                                    ...
                                                    <tr key={cat._id}>
                                                        ...
                                                        <td className="text-end">
                                                            <div className="d-flex justify-content-end gap-2">
                                                                <Link to={`/consumer/detail/${cat?._id}`} className="btn btn-sm btn-light"><FiEye /></Link>
